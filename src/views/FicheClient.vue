          ...
          if (response.data) {
            ...
            if (this.entreprises) {
              ...
              this.entreprises.forEach(element => {
                element.libelle = element.enseigne ? element.nom_raison_sociale + ' (' + element.enseigne + ')' : element.nom_raison_sociale
              })
            }
          }
        }).catch(e => {
    ...
    selectEntreprise (item) {
      if (item) {
        ...
        this.client.entreprise = {
          ...
          libelle: item.enseigne ? item.nom_raison_sociale + ' (' + item.enseigne + ')' : item.nom_raison_sociale
        }
      }
    },
    /**
