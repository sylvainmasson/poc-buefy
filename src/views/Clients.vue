...
export default {
  ...
  methods: {
    ...
    exporter () {
      ...
      if ((this.$refs.clients) && (this.$refs.clients.$data) && (this.$refs.clients.$data.newData)) {
      ...
      dataExport.forEach(element => {
        ...
        element.latitude = element.adresse.coordonnees && element.adresse.coordonnees.length > 1 ? element.adresse.coordonnees[0] : 0
        element.longitude = element.adresse.coordonnees && element.adresse.coordonnees.length > 1 ? element.adresse.coordonnees[1] : 0
      ...
      const csv = exportService.toCsv({ header: this.fields, data: dataExport, delimiter: ';' })
